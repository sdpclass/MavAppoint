...
<div class="container">
	...
	<div class="col-md-4 col-lg-4">
		<div class="form-group">
		 ...
		 <label for="emailAddress"><font style="color:#e67e22" size="4">Email Address</label>
		...
		<div class="form-group">
		 <label for="notificationEmail"><font style="color:#e67e22" size="4">Notification Email</label>
		...
		<div class="form-group">
		 <label for="reminderEmail"><font style="color:#e67e22" size="4">Reminder Email</label>
