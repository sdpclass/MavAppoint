...
public class TestAdminLogin {
  ...
  public void testAdminLogin() throws Exception {
    ...
    driver.findElement(By.name("emailAddress")).sendKeys("testadmin@uta.edu");
    driver.findElement(By.name("password")).clear();
    driver.findElement(By.name("password")).sendKeys("test1234");
    driver.findElement(By.cssSelector("button.btn.btn-primary")).click();
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if ("You are logged in as an Admin.".equals(driver.findElement(By.linkText("You are logged in as an Admin.")).getText())) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }
